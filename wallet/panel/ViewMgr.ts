namespace BlackCat {
    ...
    export class ViewMgr {
        ...
        buyExchangeListDetailView: BuyExchangeListDetailView // 更多记录
            ...
            switch (type) {
                ...
                case "BuyExchangeDepositView" :
                    ...
                    if(!this.buyExchangeDepositView) {
                        this.buyExchangeDepositView = new BuyExchangeDepositView();
                ...
                console.log("[BlaCat]", '[ViewMgr]', '显示更多记录(' + type + ') ...')
                    ...
                    this.buyExchangeListDetailView = new BuyExchangeListDetailView();
