...
(function (BlackCat) {
    class BuyExchangeDepositView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            this.walletAmount.innerText = BuyExchangeDepositView.balance + " " + BlackCat.BuyExchangePurchaseView.callback_params.type_src;
    ...
    class BuyExchangePurchaseView extends BlackCat.ViewBase {
        ...
        changecoin(type) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                BlackCat.BuyExchangeDepositView.balance = BlackCat.PayView.tokens_coin[type];
