...
(function (BlackCat) {
    class BuyExchangeDepositView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            this.walletAmount.value = BlackCat.BuyExchangePurchaseView.balance;
            this.walletAmount.innerText = BlackCat.BuyExchangePurchaseView.balance + " " + BlackCat.BuyExchangePurchaseView.callback_params.type_src;
            ...
            this.withdrawwalletAmount.value = BlackCat.BuyExchangePurchaseView.balance;
            this.withdrawwalletAmount.textContent = BlackCat.BuyExchangePurchaseView.balance + " " + BlackCat.BuyExchangePurchaseView.callback_params.type_src;
    ...
    class BuyExchangePurchaseView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            for (let i = 0; i < BlackCat.PayView.tokens.length; i++) {
                let coin = BlackCat.PayView.tokens[i];
                this.getAssets();
                let assetElement = this.objCreate("div");
                assetElement.classList.add("assetelement");
                assetElement.innerHTML = BlackCat.PayExchangeShowWalletView.callback_params.type_src;
                ...
                this.exchangeBalance.textContent = this.btcwalletBalance;
                ...
                this.walletBalance.textContent = this.btcwalletBalance;
                ...
                assetElement.onclick = () => {
                    BlackCat.BuyExchangeDepositView.refer = "";
                    BlackCat.BuyExchangeDepositView.callback_params = BuyExchangePurchaseView.callback_params;
                    BlackCat.BuyExchangeDepositView.balance = BuyExchangePurchaseView.balance;
        ...
        getAssets() {
            this.btcwalletBalance = BlackCat.Main.viewMgr.payView.btc;
            this.ethwalletBalance = BlackCat.Main.viewMgr.payView.eth;
            this.neowalletBalance = BlackCat.Main.viewMgr.payView.neo;
        }
        changeToken(type) {
