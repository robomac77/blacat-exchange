    ...
    class BuyExchangePurchaseView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            for (let i = 0; i < BlackCat.PayView.tokens.length; i++) {
                ...
                this.exchangeBalance.textContent = this.btcBalance;
                ...
                this.walletBalance.textContent = this.btcBalance;
        ...
        getAssets() {
            this.btcBalance = BlackCat.Main.viewMgr.payView.btc;
            this.ethBalance = BlackCat.Main.viewMgr.payView.eth;
            this.neoBalance = BlackCat.Main.viewMgr.payView.neo;
        }
        changeToken(type) {
