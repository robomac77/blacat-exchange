...
(function (BlackCat) {
    class BuyExchangeDepositView extends BlackCat.ViewBase {
        ...
        makeWithdraw() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!BlackCat.Main.viewMgr.payView.checkTransCount(this.inputwithdrawCount.value)) {
                    BlackCat.Main.showErrMsg("buy_exchange_purchase_amount_error", () => {
                ...
                if (Number(this.inputwithdrawCount.value) > BlackCat.Main.viewMgr.buyExchangePurchaseView.btcwalletBalance) {
                    BlackCat.Main.showErrMsg("buy_exchange_purchase_not_enough", () => {
                        this.inputwithdrawCount.focus();
                    });
                    return;
                }
                if (Number(this.inputwithdrawCount.value) > BlackCat.Main.viewMgr.buyExchangePurchaseView.ethwalletBalance) {
                    BlackCat.Main.showErrMsg("buy_exchange_purchase_not_enough", () => {
                        this.inputwithdrawCount.focus();
                    });
                    return;
