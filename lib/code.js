...
(function (BlackCat) {
    class BuyExchangeView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            spanRecentRecord.innerText = BlackCat.Main.langMgr.get("buy_exchange_pay_recent");
            ...
            this.recgetMoreDiv = this.objCreate("div");
    ...
    BuyExchangeView.exTabs = ["myasset", "buyin", "sellout", "tradelog"];
