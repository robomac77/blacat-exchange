...
(function (BlackCat) {
    class BuyExchangePurchaseView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            var gasAmount = BlackCat.AreaView.getAreaByLang(BlackCat.Main.langMgr.type);
            gasAmount.forEach(area => {
                var gasoption = this.objCreate("option");
                gasoption.setAttribute("value", area.codename);
                gasoption.textContent = BlackCat.Main.langMgr.get("area_code_" + area.codename);
                if (area.codename == "CN") {
