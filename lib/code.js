...
var BlackCat;
(function (BlackCat) {
    class NetFeeNoSlide extends BlackCat.ComponentBase {
        constructor(parentDiv, callback, net_fees = []) {
            super();
            this.parentDiv = parentDiv;
            this.callback = callback;
    ...
    BlackCat.NetFeeNoSlide = NetFeeNoSlide;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
    class LangBase {
    ...
    class LangCN extends BlackCat.LangBase {
        constructor() {
            ...
            this.lang = {
                ...
                buy_exchange_pay_unconfirmed: "当前有 ",
                buy_exchange_pay_processing: " 交易正在处理中",
                buy_exchange_pay_recentgame: "近期记录",
                ...
                buy_exchange_purchase_buyconfirmed: "买入",
                buy_exchange_purchase_sellunconfirmed: "卖出中",
                buy_exchange_purchase_sellconfirmed: "卖出",
    ...
    class LangEN extends BlackCat.LangBase {
        constructor() {
            ...
            this.lang = {
                ...
                buy_exchange_purchase_depositamount: "Input Deposit Amount",
                buy_exchange_purchase_withdrawamount: "Input Withdraw Amount",
                ...
                buy_exchange_purchase_buyunconfirmed: "Buy In Process",
                buy_exchange_purchase_buyconfirmed: "Buy Confirmed",
                buy_exchange_purchase_sellunconfirmed: "Sell In Progress",
                buy_exchange_purchase_sellconfirmed: "Sell Confirmed",
        ...
        change2Main(callback) {
            return __awaiter(this, void 0, void 0, function* () {
                this.selectNode(() => {
                    ...
                    BlackCat.tools.CoinTool.id_CNEO_OLD = [];
                    BlackCat.tools.WWW.api_cneo = '';
                    BlackCat.tools.CoinTool.id_BCT = "";
                    BlackCat.tools.CoinTool.id_BCT_DESTROY = "";
                    BlackCat.tools.CoinTool.id_BCP = "";
...
(function (BlackCat) {
    class AreaView extends BlackCat.ViewBase {
        ...
        static getByGas(gasVolume) {
            var gasInfo = null;
            AreaView.gasAmount.forEach(gas => {
...
var BlackCat;
(function (BlackCat) {
    class BuyExchangeDepositView extends BlackCat.ViewBase {
        constructor() {
            super(...arguments);
        ...
        create() {
            ...
            this.depositSpan.innerText = BlackCat.Main.langMgr.get("buy_exchange_purchase_deposit");
            ...
            this.withdrawSpan.innerText = BlackCat.Main.langMgr.get("buy_exchange_purchase_withdraw");
            ...
            divExBalanceLabel.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_exchangebalance");
            ...
            divwalletBalanceLabel.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_walletbalance");
            ...
            this.walletAmount.innerText = BuyExchangeDepositView.balance + " " + BuyExchangeDepositView.callback_params.type_src;
            ...
            divExDepLabel.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_depositlabel");
            this.ObjAppend(divCountBar, divExDepLabel);
            this.inputCount = this.objCreate("input");
            this.inputCount.classList.add("inputlabel");
            this.inputCount.placeholder = BlackCat.Main.langMgr.get("buy_exchange_purchase_depositamount");
            ...
            divgasLabel.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_gas");
            ...
            butConfirmDeposit.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_confirmdeposit");
            ...
            divExWithdrawLabel.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_exchangebalance");
            ...
            divwalletBalance.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_walletbalance");
            ...
            this.withdrawwalletAmount.value = BuyExchangeDepositView.balance;
            this.withdrawwalletAmount.textContent = BuyExchangeDepositView.balance + " " + BuyExchangeDepositView.callback_params.type_src;
            ...
            divExWithLabel.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_withdrawlabel");
            this.ObjAppend(divwithdrawCountBar, divExWithLabel);
            this.inputwithdrawCount = this.objCreate("input");
            this.inputwithdrawCount.placeholder = BlackCat.Main.langMgr.get("buy_exchange_purchase_withdrawamount");
            ...
            divgasfee.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_gas");
            ...
            butConfirmWithdraw.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_confirmwithdraw");
            butConfirmWithdraw.onclick = () => {
            };
            this.ObjAppend(this.withdrawDiv, butConfirmWithdraw);
        }
        toRefer() {
            if (BlackCat.PayExchangeShowWalletView.refer) {
                BlackCat.Main.viewMgr.change(BlackCat.PayExchangeShowWalletView.refer);
                BlackCat.PayExchangeShowWalletView.refer = null;
            }
        }
        key_esc() {
            this.doCancel();
        ...
        makeDeposit() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!BlackCat.Main.viewMgr.payView.checkTransCount(this.inputCount.value)) {
                    BlackCat.Main.showErrMsg("buy_exchange_purchase_amount_error", () => {
                        this.inputCount.focus();
                    });
                    return;
                }
                var net_fee = this.net_fee;
                if (Number(net_fee) > BlackCat.Main.viewMgr.payView.gas) {
                    BlackCat.Main.showErrMsg("buy_exchange_purchase_gas_fee_error", () => {
                        this.inputCount.focus();
                    });
                    return;
                }
                if (Number(this.inputCount.value) > BlackCat.Main.viewMgr.buyExchangePurchaseView.btcwalletBalance) {
                    BlackCat.Main.showErrMsg("buy_exchange_purchase_not_enough", () => {
                        this.inputCount.focus();
                    });
                    return;
                }
                if (Number(this.inputCount.value) > BlackCat.Main.viewMgr.buyExchangePurchaseView.ethwalletBalance) {
                    BlackCat.Main.showErrMsg("buy_exchange_purchase_not_enough", () => {
                        this.inputCount.focus();
                    });
                    return;
        ...
        addGetWalletLists() {
            var type = BlackCat.PayExchangeShowWalletView.callback_params.type_src;
            var timeout = 1000;
            switch (type) {
                case "BTC":
                    timeout = 15 * 60 * 1000;
    ...
    BlackCat.BuyExchangeDepositView = BuyExchangeDepositView;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
    class BuyExchangeListDetailView extends BlackCat.ViewBase {
        constructor() {
            super();
            if (!BuyExchangeListDetailView.list) {
                BuyExchangeListDetailView.list = new BlackCat.walletLists();
            }
        }
        create() {
            this.div = this.objCreate("div");
            ...
            if (BuyExchangeListDetailView.list && BuyExchangeListDetailView.list.hasOwnProperty("wallet")) {
                ...
                contentObj.innerHTML
                    = '<ul>'
                        ...
                        + '</div>'
                        + '<div class="pc_txinfo">'
                        + '<div class="pc_txname">' + BlackCat.Main.viewMgr.payView.getListName(BuyExchangeListDetailView.list) + '</div>'
                        + '<span class="pc_date">' + BlackCat.Main.viewMgr.payView.getListCtm(BuyExchangeListDetailView.list) + '</span>'
                        + '</div>'
                        + '<div class="pc_amounts ' + BlackCat.Main.viewMgr.payView.getListCntsClass(BuyExchangeListDetailView.list) + ' "><span>'
                        + this.getCnts()
                        + '</span>'
                        + '<div class="pc_payheighet iconfont icon-bc-diejia">' + BlackCat.Main.viewMgr.payView.getListBlockindex(BuyExchangeListDetailView.list) + '</div>'
                        + BlackCat.Main.viewMgr.payView.getListState(BuyExchangeListDetailView.list).outerHTML
                        + '</div>'
                        + '</li>'
        ...
        toRefer() {
            if (BuyExchangeListDetailView.refer) {
                BlackCat.Main.viewMgr.change(BuyExchangeListDetailView.refer);
        ...
        getParams() {
            var html = "";
            var params = BuyExchangeListDetailView.list.params;
            if (params) {
                try {
                    ...
                    if (params instanceof Array) {
                        if (BuyExchangeListDetailView.list.type == "6"
                            || BuyExchangeListDetailView.list.type == "7"
                            || BuyExchangeListDetailView.list.type == "8"
                            || BuyExchangeListDetailView.list.type == "13") {
                            for (let k in params) {
                            ...
                            for (let k in params) {
                                html += '<li class="pc_contractAddress">'
                                    ...
                                    + '<div><label>' + BlackCat.Main.langMgr.get("paylist_sbPushString") + '</label><p>' + params[k].sbPushString + BlackCat.Main.viewMgr.payView.getListParamsMethods_extInfo(BlackCat.PayListDetailView.list) + '</p></div>'
                                    + '</li>';
                            }
                        }
                    }
    ...
    BlackCat.BuyExchangeListDetailView = BuyExchangeListDetailView;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
    class BuyExchangePurchaseView extends BlackCat.ViewBase {
        constructor() {
            super();
            this.s_getWalletLists = {};
            this.page = 1;
        ...
        create() {
            ...
            myAssetspan.innerText = BlackCat.Main.langMgr.get("buy_exchange_purchase_myasset");
            myAssetspan.onclick = () => {
            ...
            buyInspan.innerText = BlackCat.Main.langMgr.get("buy_exchange_purchase_buyin");
            buyInspan.onclick = () => {
                this.tradelogDiv.style.display = "none";
            ...
            sellOutspan.innerText = BlackCat.Main.langMgr.get("buy_exchange_purchase_sellout");
            this.ObjAppend(divexTab, sellOutspan);
            var tradeLogspan = this.objCreate("div");
            tradeLogspan.innerText = BlackCat.Main.langMgr.get("buy_exchange_purchase_tradelog");
            ...
            this.divSelectToken.innerText = BlackCat.Main.langMgr.get("buy_exchange_purchase_selecttoken");
            this.ObjAppend(divSelectBox, this.divSelectToken);
            this.selectToken = this.objCreate("select");
            this.selectToken.classList.add("tokenoption");
            var tokenType = BlackCat.AreaView.getAreaByLang(BlackCat.Main.langMgr.type);
            tokenType.forEach(area => {
                var tokenoption = this.objCreate("option");
                tokenoption.setAttribute("value", area.codename);
                tokenoption.textContent = BlackCat.Main.langMgr.get("token_type_" + area.codename);
                if (area.codename == "EN") {
            ...
            this.inputPrice = this.objCreate("input");
            this.inputPrice.setAttribute("type", "number");
            this.inputPrice.classList.add("inputprice");
            this.inputPrice.placeholder = BlackCat.Main.langMgr.get("buy_exchange_purchase_inputpriceplaceholder");
            ...
            this.inputAmount.placeholder = BlackCat.Main.langMgr.get("buy_exchange_purchase_inputamountplaceholder");
            ...
            gasSelect.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_gas");
            this.ObjAppend(divSelectBox, gasSelect);
            this.selectGas = this.objCreate("select");
            this.selectGas.classList.add("gasoption");
            var gasAmount = BlackCat.AreaView.getGasByAmount(BlackCat.Main.langMgr.type);
            gasAmount.forEach(gas => {
                var gasoption = this.objCreate("option");
            });
            ...
            butBuyIn.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_buyin");
            butBuyIn.onclick = () => {
            };
            ...
            divPriceTitle.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_price");
            this.ObjAppend(divTitleBar, divPriceTitle);
            var divAmountTitle = this.objCreate("span");
            divAmountTitle.classList.add("amount");
            divAmountTitle.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_amount");
            ...
            this.buyPriceTable = this.objCreate("div");
            ...
            this.sellPriceTable = this.objCreate("div");
            ...
            this.inputassetSearch = this.objCreate("input");
            this.inputassetSearch.placeholder = BlackCat.Main.langMgr.get("buy_exchange_purchase_assetsearch");
            ...
            BlackCat.PayView.tokens_coin.forEach((coins) => {
                coins.forEach((coin) => {
                    ...
                    this.assetElement.innerHTML = BlackCat.Main.langMgr.get(coin);
                    ...
                    this.walletBalance.textContent = BlackCat.Main.viewMgr.payView[coin];
        ...
        dogetBrokerBalance(token) {
            return __awaiter(this, void 0, void 0, function* () {
                var res = yield BlackCat.ApiTool.getBrokerBalance(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token);
        ...
        depositCoin(type) {
            return __awaiter(this, void 0, void 0, function* () {
                this.hidden();
                BlackCat.BuyExchangeDepositView.refer = "BuyExchangePurchaseView";
                BlackCat.BuyExchangeDepositView.callback_params = {
                    type_src: type.toUpperCase(),
                };
                BlackCat.Main.viewMgr.change("BuyExchangeDepositView");
            });
        }
        doExchangeBTC() {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.BuyExchangeDepositView.balance = BlackCat.Main.viewMgr.payView.btc;
                this.depositCoin("btc");
            });
        }
        doExchangeETH() {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.BuyExchangeDepositView.balance = BlackCat.Main.viewMgr.payView.eth;
                this.depositCoin("eth");
            });
        }
        doExchangeCNEO() {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.BuyExchangeDepositView.balance = BlackCat.Main.viewMgr.payView.cneo;
                this.depositCoin("cneo");
            });
        }
        doExchangeNEO() {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.BuyExchangeDepositView.balance = BlackCat.Main.viewMgr.payView.neo;
                this.depositCoin("neo");
            });
        }
        doExchangeCGAS() {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.BuyExchangeDepositView.balance = BlackCat.Main.viewMgr.payView.cgas;
                this.depositCoin("cgas");
            });
        }
        doExchangeGAS() {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.BuyExchangeDepositView.balance = BlackCat.Main.viewMgr.payView.gas;
                this.depositCoin("gas");
            });
        }
        doExchangeBCP() {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.BuyExchangeDepositView.balance = BlackCat.Main.viewMgr.payView.bcp;
                this.depositCoin("bcp");
            });
        }
        doExchangeBCT() {
            return __awaiter(this, void 0, void 0, function* () {
                BlackCat.BuyExchangeDepositView.balance = BlackCat.Main.viewMgr.payView.bct;
        ...
        doGetTransferLog() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                var res = yield BlackCat.ApiTool.getBrokerTransferLog(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token, this.page, this.num, 0);
                if (res.r) {
                    if (res.data && res.data.length >= 1) {
                        yield res.data.forEach(txlist => {
                            ...
                            txlistObj.onclick = () => {
                                ...
                                BlackCat.PayListDetailView.list = txlist;
                            ...
                            tokenname_div.textContent = BlackCat.Main.viewMgr.payView.getListName(txlist);
                            this.ObjAppend(txcontent_div, tokenname_div);
                            var txdate_p = this.objCreate("p");
                            txdate_p.classList.add("pc_date");
                            txdate_p.textContent = BlackCat.Main.viewMgr.payView.getListParamMethods(txlist);
                            ...
                            txamount_span.textContent = BlackCat.Main.viewMgr.payView.getListCtmMsg(txlist);
        ...
        doTradeRequest() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!BlackCat.Main.viewMgr.payView.checkTransCount(this.inputPrice.value)) {
                    BlackCat.Main.showErrMsg("buy_exchange_purchase_amount_error", () => {
                        this.inputPrice.focus();
                    });
                    return;
                }
                if (!BlackCat.Main.viewMgr.payView.checkTransCount(this.inputAmount.value)) {
                    BlackCat.Main.showErrMsg("buy_exchange_purchase_amount_error", () => {
    ...
    BlackCat.BuyExchangePurchaseView = BuyExchangePurchaseView;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
    class BuyExchangeUnconfirmedTxView extends BlackCat.ViewBase {
        create() {
            this.div = this.objCreate("div");
            ...
            this.ObjAppend(headerTitle, returnA);
            var headerh1 = this.objCreate("h1");
            headerh1.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_txtitle");
            this.ObjAppend(headerTitle, headerh1);
            var alltx = this.objCreate("div");
            alltx.classList.add("pc_alltxtitle");
            alltx.textContent = BlackCat.Main.langMgr.get("buy_exchange_purchase_alltx");
            this.ObjAppend(headerTitle, alltx);
            this.divRecLists = this.objCreate("ul");
            this.ObjAppend(this.div, this.divRecLists);
            this.divRecListsMore = this.objCreate("div");
                ...
                if (res.r) {
                    if (res.data && res.data.length >= 1) {
                        yield res.data.forEach(txlist => {
                            ...
                            img.src = BlackCat.Main.viewMgr.payView.getListImg(txlist);
                            ...
                            txtime_div.textContent = BlackCat.Main.viewMgr.payView.getListName(txlist);
                            this.ObjAppend(txcontent_div, txtime_div);
                            var txmethod = this.objCreate("p");
                            txmethod.classList.add("pc_txrecmethod");
                            txmethod.textContent = BlackCat.Main.viewMgr.payView.getListParamMethods(txlist);
                            this.ObjAppend(txcontent_div, txmethod);
                            this.ObjAppend(txlistObj, txcontent_div);
                            var cnts_div = this.objCreate("div");
                            cnts_div.classList.add("pc_reccnts");
                            var state = BlackCat.Main.viewMgr.payView.getListState(txlist);
                            if (state)
                                this.ObjAppend(cnts_div, state);
                            this.ObjAppend(txlistObj, cnts_div);
                            this.ObjAppend(this.divRecLists, txlistObj);
                        });
                    }
                    else {
                        this.divRecListsMore.textContent = BlackCat.Main.langMgr.get("paylist_noRecord");
                    }
                }
                else {
                    BlackCat.Main.showErrCode(res.errCode);
    ...
    BlackCat.BuyExchangeUnconfirmedTxView = BuyExchangeUnconfirmedTxView;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
    class BuyExchangeView extends BlackCat.ViewBase {
        constructor() {
            super(...arguments);
            this.s_getWalletLists = {};
        }
        reset() {
            ...
            for (let token in BlackCat.PayView.tokens_old) {
                BlackCat.PayView.tokens_old[token].forEach((coin) => {
        ...
        create() {
            ...
            butReceivables.textContent = BlackCat.Main.langMgr.get("buy_exchange_pay_received");
            ...
            makeTransferObj.textContent = BlackCat.Main.langMgr.get("buy_exchange_pay_sent");
            ...
            spanRecord.innerText = BlackCat.Main.langMgr.get("buy_exchange_pay_balance");
            this.ObjAppend(liRecord, spanRecord);
            this.divListsMore = this.objCreate("button");
            this.divListsMore.classList.add("pc_abcbalance");
            this.divListsMore.textContent = BuyExchangeView.balance.toString();
            this.divListsMore.onclick = () => {
                BlackCat.BuyExchangePurchaseView.refer = "";
                BlackCat.BuyExchangePurchaseView.callback_params = BuyExchangeView.callback_params;
                BlackCat.BuyExchangePurchaseView.balance = BuyExchangeView.balance;
                BlackCat.Main.viewMgr.change("BuyExchangePurchaseView");
            };
            ...
            txunConfirmedDiv.innerText = BlackCat.Main.langMgr.get("buy_exchange_pay_unconfirmed");
            txunConfirmedDiv.onclick = () => {
                BlackCat.BuyExchangeUnconfirmedTxView.refer = "";
                BlackCat.BuyExchangeUnconfirmedTxView.callback_params = BuyExchangeView.callback_params;
                BlackCat.Main.viewMgr.change("BuyExchangeUnconfirmedTxView");
            };
            ...
            txprocessingDiv.innerText = BlackCat.Main.langMgr.get("buy_exchange_pay_processing");
            ...
            for (let i = 0; i < BlackCat.PayView.extokens.length; i++) {
                let token = BlackCat.PayView.extokens[i];
                ...
                for (let k = 0; k < BlackCat.PayView.tokens_coin[i].length; k++) {
                    let coin = BlackCat.PayView.tokens_coin[i][k];
            ...
            this["token_" + BlackCat.PayView.tokens[0]].classList.add("active");
            this["token_list_" + BlackCat.PayView.tokens[0]].style.display = "";
            for (let token in BlackCat.PayView.tokens_old) {
                BlackCat.PayView.tokens_old[token].forEach((coin) => {
            ...
            spanRecentRecord.innerText = BlackCat.Main.langMgr.get("buy_exchange_pay_recentgame");
            ...
            this.divRecListsMore.textContent = BlackCat.Main.langMgr.get("buy_exchange_pay_more");
            this.divRecListsMore.onclick = () => {
                this.hidden();
            };
        ...
        doGetBalances() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                BlackCat.PayView.tokens_coin.forEach(token => {
                    token.forEach(coin => {
                ...
                for (let k in BlackCat.PayView.tokens_old) {
                    BlackCat.PayView.tokens_old[k].forEach(coin => {
        ...
        updateBalance() {
            let type_lowcase = BlackCat.PayExchangeShowWalletView.callback_params.type_src.toLowerCase();
            BlackCat.PayExchangeShowWalletView.balance = BlackCat.Main.viewMgr.payView[type_lowcase];
            this.balanceElement.textContent = BlackCat.PayExchangeShowWalletView.balance.toString();
        }
    }
    BlackCat.BuyExchangeView = BuyExchangeView;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
...
(function (BlackCat) {
    class ModifyVipView extends BlackCat.ViewBase {
        ...
        static pay(pay_way, month, invite, net_fee, trust = "0", callback = null, isSDK = false, sdkParams = null) {
            return __awaiter(this, void 0, void 0, function* () {
                if (BlackCat.Main.isWalletOpen()) {
                    ...
                    var uid_res = yield ModifyVipView.checkUidFromApi(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token, invite);
                    if (!uid_res) {
                        if (isSDK) {
                            var rtn_res = new BlackCat.Result();
                            rtn_res.err = true;
        ...
        static checkUidFromApi(uid, token, inviter_code) {
            return __awaiter(this, void 0, void 0, function* () {
                if (inviter_code && inviter_code != "") {
                    var res = yield BlackCat.ApiTool.validInvite(uid, token, inviter_code);
                    if (res.r == 1) {
                        if (res.data != "") {
                            return true;
                        }
    ...
    class PayExchangeBCTView extends BlackCat.ViewBase {
        ...
        getIframeUrl() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                var res = yield BlackCat.ApiTool.getBctIframe(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token, BlackCat.Main.langMgr.type, BlackCat.Main.langMgr.type, t);
                if (res.r) {
...
var BlackCat;
(function (BlackCat) {
    class PayExchangeRefundView extends BlackCat.ViewBase {
        constructor() {
            super(...arguments);
            this.txHash = this.getBuyContractHash();
        }
        start() {
            super.start();
        ...
        create() {
            ...
            var popupTitle = this.objCreate('div');
            popupTitle.classList.add("pc_popup_title");
            popupTitle.innerText = BlackCat.Main.langMgr.get("pay_exchange_refund_transfer") + PayExchangeRefundView.callback_params.type_src;
            this.ObjAppend(popupbox, popupTitle);
            ...
            this.inputTransferAddr.placeholder = BlackCat.Main.langMgr.get("pay_exchange_refund_address");
            ...
            this.inputTransferCount.placeholder = BlackCat.Main.langMgr.get("pay_exchange_refund_amount");
        ...
        toRefer() {
            if (PayExchangeRefundView.refer) {
                BlackCat.Main.viewMgr.change(PayExchangeRefundView.refer);
        ...
        doWithdraw() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!BlackCat.Main.viewMgr.payView.verifyAddr(this.inputTransferAddr.value)) {
                    BlackCat.Main.showErrMsg("pay_exchange_refund_addrformat_error", () => {
                        this.inputTransferAddr.focus();
                    });
                    return;
                }
                if (!BlackCat.Main.viewMgr.payView.checkTransCount(this.inputTransferCount.value)) {
                    BlackCat.Main.showErrMsg("pay_exchange_refund_amount_error", () => {
                ...
                try {
                    ...
                    var wallet = BlackCat.Main.user.info.wallet;
                    var transfer_type = PayExchangeRefundView.callback_params.type_src;
                    var destroy_addr = BlackCat.tools.CoinTool["id_" + transfer_type + "_DESTROY"];
                    var res = yield BlackCat.tools.CoinTool.nep5Transaction(wallet, destroy_addr, BlackCat.tools.CoinTool["id_" + transfer_type], this.inputTransferCount.value, net_fee);
                }
                catch (e) {
                    var res = new BlackCat.Result();
                    res.err = true;
                ...
                if (res) {
                    ...
                    if (res.err == false) {
                        yield BlackCat.ApiTool.addUserWalletLogs(BlackCat.Main.user.info.uid, BlackCat.Main.user.info.token, res.info, "0", this.inputTransferCount.value, "19", '{"sbPushString":"transfer", "toaddr":"' + tat_addr + '", "count": "' + this.inputTransferCount.value + '", "nnc": "' + BlackCat.tools.CoinTool["id_" + transfer_type] + '"}', BlackCat.Main.netMgr.type, "0", net_fee, BlackCat.PayTransferView.log_type_detail[transfer_type.toLowerCase()]);
                        BlackCat.Main.showInfo("pay_exchange_refund_do_succ");
                        this.remove();
                        if (PayExchangeRefundView.callback)
                            PayExchangeRefundView.callback();
                        PayExchangeRefundView.callback = null;
                    }
                    else {
                        BlackCat.Main.showErrMsg(("pay_exchange_refund_do_fail"));
                    }
                }
                else {
                    BlackCat.Main.showErrMsg(("pay_exchange_refund_do_fail"));
        ...
        getBuyContractHash() {
            var cHash = "";
            if (BlackCat.tools.CoinTool.hasOwnProperty("id_" + PayExchangeRefundView.callback_params.type)) {
                cHash = BlackCat.tools.CoinTool["id_" + PayExchangeRefundView.callback_params.type];
            }
            return cHash;
        }
        updateBalance() {
    ...
    PayExchangeRefundView.crosschain_fee = "0.0001";
    BlackCat.PayExchangeRefundView = PayExchangeRefundView;
})(BlackCat || (BlackCat = {}));
var BlackCat;
(function (BlackCat) {
    class PayExchangeShowWalletView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            refundButton.textContent = BlackCat.Main.langMgr.get("pay_exchange_refund_transfer");
            this.ObjAppend(divAddress, refundButton);
            refundButton.onclick = () => {
                BlackCat.BuyExchangeView.refer = "";
                BlackCat.BuyExchangeView.callback_params = PayExchangeShowWalletView.callback_params;
                BlackCat.BuyExchangeView.balance = PayExchangeShowWalletView.balance;
                BlackCat.Main.viewMgr.change("BuyExchangeView");
            };
...
(function (BlackCat) {
    class PersonalCenterView extends BlackCat.ViewBase {
        create() {
            ...
            this.liMyinfovip.textContent = BlackCat.Main.langMgr.get("myinfo_member");
            ...
            switch (type) {
                ...
                case "PayExchangeRefundView":
                    ...
                    if (!this.payExchangeRefundView) {
                        this.payExchangeRefundView = new BlackCat.PayExchangeRefundView();
                ...
                case "BuyExchangeView":
                    ...
                    if (!this.buyExchangeView) {
                        this.buyExchangeView = new BlackCat.BuyExchangeView();
                ...
                case "BuyExchangePurchaseView":
                    ...
                    if (!this.buyExchangePurchaseView) {
                        this.buyExchangePurchaseView = new BlackCat.BuyExchangePurchaseView();
                        this.views[type] = this.buyExchangePurchaseView;
                    }
                    this.buyExchangePurchaseView.start();
                    break;
                case "BuyExchangeDepositView":
                    console.log("[BlaCat]", '[ViewMgr]', '显示交易所存入(' + type + ') ...');
                    if (!this.buyExchangeDepositView) {
                        this.buyExchangeDepositView = new BlackCat.BuyExchangeDepositView();
                ...
                case "BuyExchangeUnconfirmedTxView":
                    ...
                    if (!this.buyExchangeUnconfirmedTxView) {
                        this.buyExchangeUnconfirmedTxView = new BlackCat.BuyExchangeUnconfirmedTxView();
                        this.views[type] = this.buyExchangeUnconfirmedTxView;
                    }
                    this.buyExchangeUnconfirmedTxView.start();
                    break;
                case "BuyExchangeListDetailView":
                    console.log("[BlaCat]", '[ViewMgr]', '显示更多记录(' + type + ') ...');
                    if (!this.buyExchangeListDetailView) {
                        this.buyExchangeListDetailView = new BlackCat.BuyExchangeListDetailView();
                        this.views[type] = this.buyExchangeListDetailView;
                    }
                    this.buyExchangeListDetailView.start();
                    break;
            }
        }
        removeAll() {
...
(function (BlackCat) {
    class ApiTool {
        ...
        static validInvite(uid, token, inviter_code) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        static getBctIframe(uid, token, net_type, lang, m) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        static brokerWithdraw(uid, token, asset_src, amount) {
            return __awaiter(this, void 0, void 0, function* () {
