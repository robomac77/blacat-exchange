...
(function (BlackCat) {
    class BuyExchangeDepositView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            depositSpan.innerText = BlackCat.Main.langMgr.get("buy_exchange_purchase_deposit");
            this.ObjAppend(divexTab, depositSpan);
            var withdrawSpan = this.objCreate("div");
            withdrawSpan.textContent = "取出";
            withdrawSpan.innerText = BlackCat.Main.langMgr.get("buy_exchange_purchase_withdraw");
