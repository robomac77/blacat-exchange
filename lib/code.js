...
(function (BlackCat) {
    class BuyExchangeDepositView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            this.inputwithdrawCount.placeholder = BlackCat.Main.langMgr.get("buy_exchange_purchase_depositamount");
...
(function (BlackCat) {
    class BuyExchangePurchaseView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            divSelectToken.innerText = BlackCat.Main.langMgr.get("buy_exchange_purchase_selecttoken");
            ...
            tokenType.forEach(token => {
                ...
                tokenoption.textContent = BlackCat.Main.langMgr.get("token_type_" + token.codename);
