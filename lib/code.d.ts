...
declare namespace BlackCat {
    class LangCN extends LangBase {
        lang: {
            ...
            buy_exchange_purchase_selecttoken: string;
            buy_exchange_purchase_inputpriceplaceholder: string;
            buy_exchange_purchase_inputamountplaceholder: string;
            buy_exchange_purchase_price: string;
...
declare namespace BlackCat {
    class ModifyVipView extends ViewBase {
        ...
        static checkUidFromApi(uid: string, token: string, inviter_code: string): Promise<boolean>;
    }
}
declare namespace BlackCat {
...
declare namespace BlackCat {
    class PayExchangeRefundView extends ViewBase {
        static balance: number;
        private inputTransferCount;
        private inputTransferAddr;
        private divTransferAddr;
        private labelName;
        private netFeeCom;
        private net_fee;
        static crosschain_fee: string;
        start(): void;
        create(): void;
        toRefer(): void;
        key_esc(): void;
...
declare namespace BlackCat {
    class ApiTool {
        ...
        static validInvite(uid: string, token: string, inviter_code: string): Promise<any>;
